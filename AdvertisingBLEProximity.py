...
note8_addr = '34:FC:EF:0C:8F:CB'
galaxyS5_addr = '9C:D3:5B:06:F6:9B'

debug = 1

while True:
    # get rssi reading for address
    rssi = bluetooth_rssi(note8_addr)

    if debug:
        print datetime.datetime.now(), rssi, rssi_prev1, rssi_prev2, far, far_count, "jop"
